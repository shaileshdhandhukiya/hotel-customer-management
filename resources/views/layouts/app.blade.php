...
<body class="font-sans antialiased">
    <div class="min-h-screen bg-gray-100">
        ...
        <footer class="bg-white mt-8 lg:mt-18">
            <div class="mx-auto max-w-screen-xl pb-8  sm:px-6 ">
                <div class="border-t border-gray-100 pt-8 sm:flex sm:items-center sm:justify-between lg:pt-5">
